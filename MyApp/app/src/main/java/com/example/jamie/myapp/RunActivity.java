    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mdbhelper.insertDistance(dateID, distance);
                cursor = mdbhelper.getDateDis(dateID);
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                ...
                for (int i=0; i<ListLength;i++) {
                    LatLng temp = LatlngSerList.get(i).getPoint();
                    PointX[i] = temp.latitude;
                    PointY[i] = temp.longitude;
                    Log.e(TAG, "x:"+PointX[i]);
                    Log.e(TAG, "y:"+PointY[i]);
                }*/
